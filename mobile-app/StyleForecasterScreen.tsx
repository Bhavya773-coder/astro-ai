...
export default function StyleForecasterScreen({
  ...
  const alternativePhotoUri = styleResult?.image_base64
    ? `data:image/png;base64,${styleResult.image_base64}`
    : null;
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {isGenerating ? (
          <View style={styles.loadingContainer}>
            ...
            <Text style={styles.loadingText}>Synthesizing cosmic style & rating outfit...</Text>
            <Text style={[styles.modifierSubtext, { marginTop: 6 }]}>Preserving your facial identity for alternative outfit try-on...</Text>
          </View>
        ) : !styleResult ? (
