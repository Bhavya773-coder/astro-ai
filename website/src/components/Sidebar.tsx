    ...
    <>
      ...
      {!isMobileMenuOpen && (
        <button
          ...
          className="lg:hidden fixed top-4 left-4 z-[60] p-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white hover:bg-white/20 transition-all duration-200"
        >
      ...
      <div className={`
        fixed top-0 left-0 h-screen bg-black/60 backdrop-blur-2xl border-r border-white/5 z-50
