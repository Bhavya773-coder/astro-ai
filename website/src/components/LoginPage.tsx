    ...
    <CosmicBackground className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-bold text-white mb-2 text-glow">Welcome Back</h1>
          <p className="text-white/60 font-body">Sign in to unlock your cosmic insights</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 rounded-cosmic bg-white/5 border border-white/20 text-white placeholder-white/40 transition-all duration-300 focus:outline-none focus:border-cosmic-pink focus:ring-2 focus:ring-cosmic-pink/30"
            ...
            <div className="flex items-center justify-end">
              <button
                ...
                className="text-sm text-cosmic-pink hover:text-cosmic-cyan transition-colors"
              >
                Forgot password?
              </button>
            </div>
